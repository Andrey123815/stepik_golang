...
#### Stepik course "Programming on Golang"
...
"In this course, we will try to teach you the basics of Go (Golang), as well as its application in various tasks. 
  The course does not consist of a solid theory, you will have to solve problems and answer questions. 
  You will get points for solving problems, the more difficult the task, the more points."
